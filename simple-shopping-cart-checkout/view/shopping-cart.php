...
<table width="100%" id="cart-table" cellpadding="10" cellspacing="1"
    ...
    foreach ($_SESSION["cart_item"] as $item) {
        ...
        <tr>
			...
			<td>
				...
				<input type="hidden" class='total' name="total" value="<?php echo $item["price"]; ?>" />
			</td>
    ...
    ?>
        <tr id="tot">
			<td class="text-right" colspan="3"><strong>Total (Rs.): </strong> <span
				id="total"><?php echo $item_total;?></span></td>
			<td class="text-right"><a id="btnEmpty"
				onClick="cartAction('empty', '');" onclick="return confirm('Are you sure you want to empty the cart?')">Empty Cart</a></td>
		</tr>
	</tbody>
</table>
<?php
